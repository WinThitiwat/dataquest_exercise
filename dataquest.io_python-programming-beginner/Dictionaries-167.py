...
pantry_counts = {}
for cur_element in pantry:
    if cur_element in pantry_counts:
        pantry_counts[cur_element] = pantry_counts[cur_element] + 1
    else:
        pantry_counts[cur_element] = 1
...
for cur_element in weather:
    if cur_element in weather_counts:
        weather_counts[cur_element] = weather_counts[cur_element] + 1
    else:
        weather_counts[cur_element] = 1 
